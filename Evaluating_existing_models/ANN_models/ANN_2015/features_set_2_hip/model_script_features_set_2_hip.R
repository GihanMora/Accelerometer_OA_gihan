...
setwd('C:/Users/gihan/Desktop/Montoye/ANN_2015/features_set_2_thigh')

#Opening nnet library for using artificial neural networks (ANNs)
library(nnet)

input_foldername <- 'C:/Users/gihan/Desktop/Montoye/ANN_2015/features_set_2_hip/inputs_for_ANN_hip_2015_feature_set_2/'
output_foldername <- 'C:/Users/gihan/Desktop/Montoye/ANN_2015/features_set_2_hip/outputs_for_ANN_hip_2015_feature_set_2/'
...
for(file in input_files){
  ...
  nnet_hip<-load("C:/Users/gihan/Desktop/Montoye/ANN_2015/features_set_2_hip/AGhipANN_FeatureSet2.RData")
  ...
  temp_name <- paste(output_foldername, paste(strsplit(file, '_ANN_input_hip_2015_feature_set_2.txt')[1], "_predicted_hip_EE_2015_feature_set_2.csv", sep=""), sep="")
  write.csv(pred_hip, temp_name)
  print(paste('predicted for hip 2015_feature_set_2 - ', file))
}
