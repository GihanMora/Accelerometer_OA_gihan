...
setwd('C:/Users/gihan/Desktop/Montoye/ANN_2015/features_set_2_hip')

#Opening nnet library for using artificial neural networks (ANNs)
library(nnet)

input_foldername <- 'C:/Users/gihan/Desktop/Montoye/ANN_2015/features_set_2_thigh/inputs_for_ANN_thigh_2015_feature_set_2/'
output_foldername <- 'C:/Users/gihan/Desktop/Montoye/ANN_2015/features_set_2_thigh/outputs_for_ANN_thigh_2015_feature_set_2/'
...
for(file in input_files){
  ...
  temp_name <- paste(output_foldername, paste(strsplit(file, '_ANN_input_thigh_2015_feature_set_2.txt')[1], "_predicted_thigh_EE_2015_feature_set_2.csv", sep=""), sep="")
  write.csv(pred_thigh, temp_name)
  print(paste('predicted for thigh 2015_feature_set_2 - ', file))
}
