...
setwd('C:/Users/gihan/Desktop/Montoye/ANN_2016')
library(nnet)
library(caret)
...
EEprediction1<-read.table(file='hip_data_2016.txt',header=TRUE)
...
write.table(pred_hip, 'C:/Users/gihan/Desktop/Montoye/ANN_2016/predicted output_hip.txt')
