# -*- coding: utf-8 -*-
"""LightGBM_graph.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1U8Kg0FWUaexIsHS50sv52kk4552PtBTD
"""
...
import Model_development.statistical_extensions as SE
...
ActiGraph_60s_epoch_proc_folder = 'F:/OA_CNN/Data/30s_statistical_data/graph/Epoch30'
...
for filename in tqdm(epoch_files):
  ...
  dataframe = pd.read_csv(ActiGraph_60s_epoch_proc_folder+'/'+filename)
  ...
  y_data_temp = dataframe[['waist_ee']]
...
print(len(X_data))
print(len(Y_data))
X_data_1 = X_data.iloc[ :1000000]
X_pred = X_data.iloc[1000000:]
Y_data_1 = Y_data.iloc[:1000000]
Y_pred = Y_data.iloc[1000000:]
...
output = pd.DataFrame()
output['pred'] = y
output['actual'] = Y_pred['waist_ee'].values
output.to_csv("F:/OA_CNN/Gihan_Scripts/lightGBM/model_outputs_graph/predictions.csv", index=False)

from scipy.stats.stats import pearsonr
from sklearn.metrics import explained_variance_score, mean_squared_error, r2_score, confusion_matrix


test_Y_data = Y_pred['waist_ee'].values
...
SE.GeneralStats.plot_confusion_matrix(cnf_matrix, classes=class_names, title='CM',
                                      output_filename=join('F:/OA_CNN/Gihan_Scripts/lightGBM/model_outputs_graph/', 'confusion_matrix.png'))
...
result_string = '\n'.join(grp_results)
with open('F:/OA_CNN/Gihan_Scripts/lightGBM/model_outputs_graph/result_report.txt', "w") as text_file:
