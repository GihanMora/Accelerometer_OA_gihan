...
class BlandAltman:
    ...
    def bland_altman_paired_plot_tested(dataframe, plot_title, plot_number, log_transformed=False,
        ...
        """
        dataframe_all, mean_bias_sb_overall, upper_loa_sb_overall, lower_loa_sb_overall = BlandAltman._bland_altman_analyse(
        ...
        BlandAltman.plot_graph(plot_number + 1, plot_title + ' - Overall Plot (98)',
                               dataframe_all['mean'], dataframe_all['diff'],
                               upper_loa_sb_overall, mean_bias_sb_overall, lower_loa_sb_overall,
                               output_filename + '_overall')
...
class GeneralStats:
    ...
    def evaluation_statistics(confusion_matrix):
        ...
        if confusion_matrix.shape == (3, 3):
            ...
            print(['data',tpa,tpb,tpc,eab,eac,eba,ebc,eca,ecb])

            # Calculate accuracy for label 1
            total_classifications = sum(sum(confusion_matrix))
            print('total',total_classifications)
            print('up',(tpa + tpb + tpc))
...
# ground_intensity = ['a','a','b','a','a','c','c','a','b','b']
# predicted_intensity = ['c','b','b','a','b','c','a','c','b','c']
